...
import com.inkfield.backend.model.BookSummary;
...
import com.inkfield.backend.persistence.ProjectJsonMapper;
import com.inkfield.backend.persistence.entity.BookEntity;
import com.inkfield.backend.persistence.entity.UserLibraryEntity;
import com.inkfield.backend.persistence.repository.BookRepository;
import com.inkfield.backend.persistence.repository.UserLibraryRepository;
...
public class BookLibraryService {
    ...
    private Project withGenre(Project project, String audienceChannel, String novelTypeId) {
        ...
        return new Project(
            new com.inkfield.backend.model.ProjectMeta(
                meta.title(),
                meta.synopsis(),
                genre,
                meta.premise(),
