...
import com.novelstudio.backend.persistence.entity.BookEntity;
import com.novelstudio.backend.persistence.entity.UserLibraryEntity;
import com.novelstudio.backend.persistence.repository.BookRepository;
import com.novelstudio.backend.persistence.repository.UserLibraryRepository;
...
public class BookLibraryService {
    ...
    private void applyProject(BookEntity entity, Project project) {
        ...
        entity.setProjectJson(projectJsonMapper.toJson(project));
    }
    ...
    private Project withGenre(Project project, String audienceChannel, String novelTypeId) {
        ...
        return new Project(
            new com.novelstudio.backend.model.ProjectMeta(
                meta.title(),
                meta.synopsis(),
                genre,
                meta.premise(),
